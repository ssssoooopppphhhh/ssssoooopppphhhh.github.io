...
![image](/assets/images/260218 eggs.png)

<p>Scientists can be a judgemental bunch. We're trained to be critical so that we can separate real signals from noise and evidence-based conclusions from biased or misguided pseudoscience. When I tripped over the word “jasplakinolide” in a presentation last year it rightfully triggered alarm bells in my audience: <i>If she didn’t even take the time to practice pronouncing that word, what other aspects of her work does she half-ass?</i> That being said, of course there are plenty of reasons someone might make a linguistic error that have no bearing on their ability to do great science. Scrutinizing the language of scientific writers or speakers quickly becomes problematic.</p>

<p>So rather than judging individuals, I thought it best to do my venting here. My personal potentially-problematic pet peeve as an audience member or editor is the misuse of singular and plural forms of nouns. The following is a list of words (singular and plural) that I have seen regularly misused even by big shot native-English-speaker academics. Although the majority of these words follow a simple set of rules derived from Latin, the exceptions are numerous enough that compiling this list granted me some newfound empathy for those who screw them up.</p>

<p><strong>-um:</strong></p>

<p>this datum -> these data</p>
<blockquote style="border: none; margin-top: 0; padding-left: 20px;">Starting off with the big one.
</blockquote>
